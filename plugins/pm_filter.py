...
@Client.on_message(filters.group & filters.text & ~filters.edited & filters.chat(-782211454 -1001510283128 -1001727823537) & filters.incoming)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🤖 Status', url='https://t.me/+BixProBUQBo4MWM9'),
            ],[
            InlineKeyboardButton('🏠 Home', callback_data='start'),
            InlineKeyboardButton('Close ❎', callback_data='close_data')
        ]]
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("🔔 Join Our Channel 🔔",url="https://t.me/+BixProBUQBo4MWM9")
    ])
